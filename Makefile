...
UPTEST_EXAMPLE_LIST ?= "examples/namespaced/object/object.yaml,examples/namespaced/object/object-watching.yaml,examples/namespaced/object/object-ssa-owner.yaml,examples/namespaced/object/object-csa-migration.yaml,examples/namespaced/object/object-wrapped-provider-config.yaml,examples/namespaced/object/policy/observe-uptodate.yaml"
