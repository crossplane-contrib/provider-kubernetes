...
type UpToDateDiffer interface {
	...
	// meaningful change.
	UpToDateDiff(ctx context.Context, obj *v1alpha1.Object, manifest, current *unstructured.Unstructured) (string, error)
}
...
func (c *external) handleObservation(ctx context.Context, obj *v1alpha1.Object, last, desired, manifest, current *unstructured.Unstructured) (managed.ExternalObservation, error) {
...
func (c *external) upToDate(ctx context.Context, obj *v1alpha1.Object, last, desired, manifest, current *unstructured.Unstructured, observeOnly bool) (bool, string) {
