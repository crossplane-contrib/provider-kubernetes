...
// Package namespaced contains Kubernetes API for the Kubernetes provider.
package namespaced
...
import (
	...
	templatev1alpha1 "github.com/crossplane-contrib/provider-kubernetes/apis/namespaced/v1alpha1"
)
