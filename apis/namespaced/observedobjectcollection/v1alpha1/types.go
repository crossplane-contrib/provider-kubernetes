...
import (
	...
	xpcommon "github.com/crossplane/crossplane/apis/v2/core/v2"
)
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,managed,kubernetes}
...
type ObservedObjectCollectionStatus struct {
	xpcommon.ManagedResourceStatus `json:",inline"`
