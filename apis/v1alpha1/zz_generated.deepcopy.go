...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesCredentialSelectors) DeepCopyInto(out *KubernetesCredentialSelectors) {
	*out = *in
	if in.Fs != nil {
		in, out := &in.Fs, &out.Fs
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesCredentialSelectors.
func (in *KubernetesCredentialSelectors) DeepCopy() *KubernetesCredentialSelectors {
	if in == nil {
		return nil
	}
	out := new(KubernetesCredentialSelectors)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProviderCredentials) DeepCopyInto(out *ProviderCredentials) {
	*out = *in
	in.KubernetesCredentialSelectors.DeepCopyInto(&out.KubernetesCredentialSelectors)
}
...
func (in *ServiceAccountSelector) DeepCopyInto(out *ServiceAccountSelector) {
	*out = *in
	out.ServiceAccountReference = in.ServiceAccountReference
}
